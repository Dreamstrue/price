...
<title>网站后台管理系统</title>
    <link type="text/css" rel="stylesheet" href="${pageContext.request.contextPath}/css/login/login.css">
                ...
                <div class="con_right">
                    ...
                    <ul>
                            ...
                            <div class="erweima">
                                <div class="qrcode">
                                    <div id="output" style="width: 100%; position: relative">
                                        <img src="${pageContext.request.contextPath}/images/login/2weima.jpg" style="width: 174px; height: 174px"></div>                                    
                                </div>
                             </div>
                        ...
                        <li class="con_r_right" style="display: block;">
                           <form name="form1" method="post" action="${pageContext.request.contextPath}/login/main" autocomplete="off">
                 <div class="user">
                        ...
                        <div><span class="mima-icon"></span>
							...
							<img style="cursor: pointer; margin-top:8px;" alt="看不清？点击更换" src="${pageContext.request.contextPath}/images/login/yanzhengma.jpg">
